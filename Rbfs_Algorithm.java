package heuristic_package;
import java.util.Comparator;
import java.util.InputMismatchException;
import java.util.PriorityQueue;
import java.util.Scanner;
 
public class Rbfs_Algorithm
{
    ...
    public Rbfs_Algorithm(int numberOfNodes)
    {
    ...
    public static void main(String... arg)
    {
        ...
        try
        {
            ...
            Rbfs_Algorithm bestFirstSearch = new Rbfs_Algorithm(number_of_vertices);
